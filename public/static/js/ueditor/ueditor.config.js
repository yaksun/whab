...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,'fontfamily':[
           ...
           { label:'',name:'timesNewRoman2',val:'Times New Roman,Times,serif'},
		...
		,whiteList: {
			...
			img:    ['src', 'alt', 'title', 'width', 'height', 'id', '_src', 'loadingclass', 'class', 'style','_url', 'data-latex','anchorname','style'],
